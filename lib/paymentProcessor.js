...
function runInterval(){
    async.waterfall([
        ...
        function(keys, balances, callback){
		    ...
		    console.log("minPayoutLevel: " + JSON.stringify(minPayoutLevel));
        ...
        function(balances, minPayoutLevel, callback){
		    ...
		    console.log("Worker: " + worker + " Balance: " + balance)
			...
			console.log(" payout:" + payout)
			    ...
			    console.log(" payout after fee: " + payout);
                    }
			console.log(" payout < 0 ? continue: " + payout)
                    if (payout < 0) {
			    continue;
		    }
		    ...
		    console.log(" for worker in payments: " + JSON.stringify(payments));
			...
			console.log("transferCommands: " + transferCommands);
			...
			console.log("transferCmd: "+ "/n" + transferCmd);
